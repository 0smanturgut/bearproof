...
**Needs:** Ubuntu 22.04/24.04, 2 vCPU and 4 GB RAM for 720p30 (the default), 4 vCPU and 8 GB for 1080p30, ~3 GB of
disk, ~4.6 Mbit/s up all the time (about 1.5 TB a month).

```bash
git clone https://github.com/0smanturgut/bearproof /opt/bearproof
bash /opt/bearproof/ops/stream/setup.sh     # packages, the stream user, the systemd unit
