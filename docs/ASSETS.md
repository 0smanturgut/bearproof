...
| `hq/assets/compare/build-{0,2}.jpg`, `hq/assets/builds/build-2.{mp4,jpg}`                                 | HQ before/after slider frames and the Build #2 trailer               | Screenshots and screen recordings of the game itself (Build #0 is the MIT upstream game, credited)                              | MIT (this repo; upstream MIT for Build #0) |
