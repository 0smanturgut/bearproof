...
Trades on pump.fun ─► creator fees (75% to the agent, 25% to ClawPump)
   ─► Patch's treasury (ClawPump agent wallet, public)
...
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **Treasury** = ClawPump agent wallet of the agent "Patch" | ClawPump (custodial agent wallet). Spending only goes through ClawPump's tools, and only to **whitelisted** addresses.                                                                | All creator fees. ClawPump forwards the 75% share hourly. | Funding the two wallets below.                                                                                               |
