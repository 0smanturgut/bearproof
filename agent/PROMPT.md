...
- **Paths.** You may change `game/**`, `devlog/build-<n>.md`, `agent/plan.md`, `agent/notes.md` and
  `agent/proposals/build-<n>.json`. Never touch `game/scripts/**`, `game/test/sim.test.js`, or
